...
import {
  ...
  FileDown, RotateCcw, User, FileText, Pencil, Sparkles,
  ArrowRight, Info,
} from "lucide-react"
...
export function WiderspruchGenerator() {
  ...
  const handleSaveToArchiv = useCallback(() => {
    // Save to localStorage under a dedicated key
    try {
  ...
  return (
    <section id="widerspruch" className="py-16 lg:py-20">
          ...
          <div className="p-6 sm:p-8">
            ...
            {step === 3 && (
              <div className="space-y-5">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <Field label="Datum des Bescheids" required>
