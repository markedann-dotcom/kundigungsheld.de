          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              <span className="text-balance">
                In drei einfachen Schritten zur Kündigung
              </span>
            </h2>
            ...
            <AnimateIn key={step.number} delay={index * 150}>
              <li className="relative">
                ...
                {index < steps.length - 1 && (
                  <div
                    className="pointer-events-none absolute left-1/2 top-16 hidden h-0.5 w-full bg-gradient-to-r from-primary/20 via-primary/30 to-primary/10 lg:block"
                    aria-hidden="true"
                  />
                )}
                ...
                <div className="relative flex flex-col items-center text-center">
                  ...
                  <div className="relative mb-6">
                    ...
                    <span
                      className="absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full bg-accent text-xs font-bold text-white"
                      aria-hidden="true"
                    >
                      {step.number}
                    </span>
