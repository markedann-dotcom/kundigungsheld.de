  ...
  return (
    <section className="py-12 lg:py-16">
      <div className="mx-auto max-w-5xl px-4 lg:px-8">
        ...
        {/* Empty State */}
        {items.length === 0 && (
          <div className="flex flex-col items-center rounded-2xl border border-border/60 bg-white py-20 text-center">
        ...
        {filteredItems.length === 0 && items.length > 0 && (
          <div className="flex flex-col items-center rounded-2xl border border-border/60 bg-white py-16 text-center">
        ...
        <div className="space-y-3">
          {filteredItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="overflow-hidden rounded-xl border border-border/60 bg-white transition-all hover:shadow-sm"
              >
                <button
                  onClick={() =>
