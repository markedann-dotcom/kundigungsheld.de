...
import { ArrowRight, Clock, User, Scale, ShieldCheck, Lightbulb, Home, Zap, FileText } from "lucide-react"
    ...
    <section id="blog" className="bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mt-10 text-center">
          <Button variant="outline" className="group gap-2 rounded-full px-6" asChild>
            <Link href="/blog">
              Alle Artikel lesen
